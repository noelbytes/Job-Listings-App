...
// useLoaderData is a hook that allows you to access the data returned by the loader function for the route.
...
export { JobPage as default, jobLoader }; // This syntax allows us to export multiple things from a single file. Here, we're exporting JobPage as the default export and jobLoader as a named export.
// Named exports are basically exports that are not default. You can have multiple named exports in a single file, but only one default export.